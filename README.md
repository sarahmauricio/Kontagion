Kontagion is a 2D game programmed using C++. It uses object-oriented programming design in order to ensure that all elements of the game world interact properly with each other.
